...
## 📜 라이선스 (상업적 사용)
- **Kokoro 모델**(영어·일본어): Apache 2.0 — 상업적 사용 가능.
- **Supertonic**(한국어): 예제 코드 MIT, **모델 OpenRAIL-M** — 상업적 사용 가능하되
  불법·유해 용도 금지 등 책임 조항 포함(일반 영상 내레이션은 해당 없음).
  원문: [Supertone/supertonic-3 LICENSE](https://huggingface.co/Supertone/supertonic-3)
- **Chatterbox**(고품질·감정 모드): MIT — 상업적 사용 가능. 생성 음성에 비가청 워터마크(Perth) 포함.
